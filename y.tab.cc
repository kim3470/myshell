...
{
       0,   247,   247,   250,   251,   255,   259,   262,   266,   267,
     271,   277,   285,   309,   313,   314,   318,   333,   344,   361,
     377,   388,   402,   405
};
#endif
...
static const char *const yytname[] =
{
  ...
  "AMPERSAND", "LESS", "GREAT", "GREATGREAT", "TWOGREAT", "GREATAMPERSAND",
  "GREATGREATAMPERSAND", "$accept", "goal", "command_list", "command_line",
  "pipe_list", "cmd_and_args", "cmd_word", "arg_list", "io_modifier_list",
...
{
       8,     9,    -8,    -8,    15,     7,    -8,    10,    -8,    -8,
      -8,    -8,    -8,    14,    -7,    16,    -8,    -8,    17,    18,
      19,    20,    21,    22,    -8,    13,    -8,    -8,    -8,    -8,
      -8,    -8,    -8,    -8
};
...
{
       0,     0,    11,     6,     0,     0,     3,    15,     8,    13,
       7,     1,     4,     0,    23,    10,     9,    22,     0,     0,
       0,     0,     0,     0,    14,     0,    12,    20,    17,    16,
      21,    19,    18,     5
};
...
static const yytype_int8 yytable[] =
{
      17,    18,    19,    20,    21,    22,    23,    -2,     1,     1,
       2,     2,     3,     3,    10,    11,    13,     2,    33,    26,
      27,    28,    29,    30,    31,    32,     0,     0,    12,     0,
       0,     0,     0,     0,     0,     0,     0,    16
};
...
static const yytype_int8 yystos[] =
{
       ...
       5,     0,    17,     6,    22,    21,    19,     7,     8,     9,
      10,    11,    12,    13,    23,    24,     3,     3,     3,     3,
       3,     3,     3,     5
};
...
#line 285 "shell.y"
		...
		if(!strchr((yyvsp[0].cpp_string)->c_str(), '*') && !strchr((yyvsp[0].cpp_string)->c_str(), '?'))
		{
			Command::_currentSimpleCommand->insertArgument((yyvsp[0].cpp_string));
		}
		else
		{
			expandWildcard((char *) "", (char *) (yyvsp[0].cpp_string)->c_str());
